...
if __name__ == "__main__":
    ...
    hiddenLayer_2 = EdgeFeatures2D(25, (11,11), 0.8, 100, tf.keras.activations.relu)(dropout_1)
    dropout_2 = tf.keras.layers.SpatialDropout2D(0.1, "channels_last")(hiddenLayer_2)
    hiddenLayer_3 = EdgeFeatures2D(13, (23,23), 0.8, 100, tf.keras.activations.relu)(dropout_2)
    dropout_3 = tf.keras.layers.SpatialDropout2D(0.25, "channels_last")(hiddenLayer_3)
    hiddenLayer_4 = EdgeFeatures2D(7, (47,47), 0.8, 100, tf.keras.activations.relu)(dropout_3)
